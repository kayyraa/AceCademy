...
const UserTestsCollection = Fire.collection(Db, "user-tests");
...
export async function UploadFile(Path = File) {
    const StorageRef = Storage.ref(Storage.getStorage(), `uploads/${Path.name}`);
    await Storage.uploadBytes(StorageRef, Path);
